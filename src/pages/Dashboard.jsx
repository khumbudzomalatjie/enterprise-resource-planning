...
export default function Dashboard() {
  ...
  const modules = [
    ...
    { 
      icon: BarChart3, 
      label: 'Reporting', 
      description: 'BI dashboards, analytics',
      path: '/reports',
    ...
    { 
      icon: FolderOpen, 
      label: 'Documents', 
      description: 'DMS, contracts, storage',
      path: '/documents',
  ...
  const isModuleBuilt = (module) => {
    const builtModules = ['/hr', '/payroll', '/crm', '/sales', '/operations', '/inventory', '/procurement', '/finance']
  ...
  const handleModuleClick = (module) => {
    ...
    const availableModules = ['/hr', '/payroll', '/crm', '/sales', '/operations', '/inventory', '/procurement', '/finance', '/dashboard', '/users']
            ...
            <motion.section key="sales" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="neu-raised p-6 rounded-3xl stat-card">
                  ...
                  <button className="mt-4 w-full py-2 rounded-xl bg-emerald-700 text-white text-sm shadow-md opacity-80 cursor-default">Sales Report</button>
                </div>
                <div className="neu-raised p-6 rounded-3xl stat-card">
                  ...
                  <button className="mt-4 w-full py-2 rounded-xl bg-emerald-700 text-white text-sm shadow-md opacity-80 cursor-default">CRM</button>
                </div>
                <div className="neu-raised p-6 rounded-3xl stat-card">
                  ...
                  <button className="mt-4 w-full py-2 rounded-xl bg-emerald-700 text-white text-sm shadow-md opacity-80 cursor-default">Follow Up</button>
                </div>
              </div>
            </motion.section>
          )}
            ...
            <motion.section key="events" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="neu-raised p-6 rounded-3xl">
                  ...
                  <div className="mt-3 space-y-2 text-slate-600 dark:text-slate-300"><p>🎉 Annual Gala · Dec 15</p><p>🏆 Team Building · Jan 10</p><p>📢 Expo 2025 · Feb 5</p></div>
                  <button className="mt-4 w-full py-2 rounded-xl bg-emerald-700 text-white opacity-80 cursor-default">Manage Events</button>
                </div>
                <div className="neu-raised p-6 rounded-3xl">
                  ...
                  <p className="mt-3 text-sm text-slate-500 dark:text-slate-400">3 venues booked | 12 vendors confirmed</p>
                  ...
                  <button className="mt-4 w-full py-2 rounded-xl bg-emerald-700 text-white opacity-80 cursor-default">Logistics Dashboard</button>
                </div>
              </div>
            </motion.section>
          )}
            ...
            <motion.section key="hr" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="neu-raised p-6 rounded-3xl stat-card">
                  ...
                  <button onClick={() => navigate('/payroll')} className="mt-4 w-full py-2 rounded-xl bg-emerald-700 text-white text-sm shadow-md hover:bg-emerald-600 transition-colors cursor-pointer">Process Payroll</button>
                </div>
                <div className="neu-raised p-6 rounded-3xl stat-card">
                  ...
                  <ul className="mt-3 space-y-2 text-sm text-slate-600 dark:text-slate-300">
                    <li className="flex justify-between"><span>Sarah K.</span><span className="text-emerald-600 dark:text-emerald-400">42 hrs</span></li>
                    <li className="flex justify-between"><span>Miguel R.</span><span className="text-emerald-600 dark:text-emerald-400">38 hrs</span></li>
                    <li className="flex justify-between"><span>Lisa M.</span><span className="text-slate-500 dark:text-slate-400">35 hrs</span></li>
                  </ul>
                </div>
              </div>
            </motion.section>
