    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-500 via-emerald-600 to-emerald-700 font-['Inter'] pb-20">
      ...
      <div className="px-5 -mt-3">
        <div className="grid grid-cols-3 gap-2">
          {[
            { icon: Briefcase, label: 'Active Jobs', value: activeJobs.length, color: 'from-blue-400 to-blue-500' },
            { icon: CheckCircle2, label: 'Done Today', value: stats.completedJobs || 0, color: 'from-green-400 to-green-500' },
            { icon: Clock, label: 'Status', value: stats.isClockedIn ? 'Clocked In' : 'Out', color: stats.isClockedIn ? 'from-amber-400 to-amber-500' : 'from-slate-400 to-slate-500' },
          ].map((s, i) => (
      ...
      <div className="px-5 mt-5">
        ...
        {loading ? (
          ...
          <div className="text-center py-10 bg-white/10 backdrop-blur rounded-2xl">
            ...
            <p className="text-white/60 text-xs mt-1">No active jobs. Pull down to refresh.</p>
          </div>
        )}
      </div>
